...
fn main() {
    App::new()
        ...
        .add_plugins((PanCamPlugin, DefaultInspectorConfigPlugin, EguiPlugin, RapierPhysicsPlugin::<NoUserData>::pixels_per_meter(100.0), CarPlugin, EnemyPlugin, PopulationPlugin, GuiPlugin))
        ...
        .add_systems(Update, (bevy::window::close_on_esc, camera_follow_system, settings_system))
        .run();
}
